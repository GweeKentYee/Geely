                ...
                <div class="card-body">
                         ...
                         @method('PUT')
                            ...
                            <div class="form-group mb-3">
                              ...
                              <input type="integer" value="{{$UsedCar->min_price}}" class="form-control @error('minimum_price') is-invalid @enderror" id="minimum_price" name="minimum_price">
                              @error('minimum_price')
                          ...
                          <div class="form-group mb-3">
                            ...
                            <input type="integer"  value="{{$UsedCar->max_price}}" class="form-control @error('maximum_price') is-invalid @enderror" id="maximum_price" name="maximum_price">
                            @error('maximum_price')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                          ...
                          <div class="form-group mb-3">
                            ...
                            <input type="varchar" value="{{$UsedCar->data_file}}" placeholder="{{$UsedCar->data_file}}" class="form-control @error('data_file') is-invalid @enderror" id="data_file" name="data_file" readonly>
                            @error('data_file')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>                              
                          ...
                          <div class="form-group mb-3">
                            <label for="" class="col-form-label">Ownership File: {{$UsedCar->ownership_file}}</label>
