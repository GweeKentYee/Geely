...
@section('content')
<div class="container" >
    <div class="row justify-content-center" style="margin-right: 0.4rem">
        <div class="col-md-12">
            <h3><u></u></h3>
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="row">
                    ...
                    <div class="col">
                      ...
                      <div class="details-content">{{$usedcar->car->carBodyType->body_type}}</div><br>
                      <div class="details-title">Variant:</div>
                      <div class="details-content">{{$usedcar->car->carVariant->variant}}</div><br>
                      <div class="details-title">Fuel:</div>
                      <div class="details-content">{{$usedcar->car->carGeneralSpec->fuel}}</div><br>
                    </div>
                    <div class="col">
                      ...
                      <div class="details-content">{{$Data[1][19]}}</div><br>
                      ...
                      <div class="details-content">{{$usedcar->car->carGeneralSpec->transmission}}</div><br>
                    </div>
                  </div>
                    <div class="row">
                      <div class= "col">
...
@section("footer-scripts")
    ...
    $(function() {
    var myicon = document.getElementById("Front_Right_Door");
